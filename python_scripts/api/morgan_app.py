...
# Purpose:
# Calculates all expenses for the user's mortgage.

# Issues/Needed Improvements:
# Calculate income taxes function is not done yet
...
# TODO: Add a compare function. To thoroughly compare two purchases
# TODO: Make monthly payment and payment due in my __init__
# TODO: Once all of those are complete, expand data to nationwide.
# TODO: Account for economic value for a house. For example, house value can go up or down depending on the economy.


def main():
    class run_program:
        def __init__(self, purchase_price, down_payment, loan_duration, interest_rate, yearly_payments, location,
                     home_type, take_home_income, file_status):
        ...
        # Take taxes out of users salary
        # Federal income tax information can be found here https://www.debt.org/tax/brackets/
        def calculate_income_taxes(self):
            test_list = [
                {'federal': [
                     {'single': [9875, 40125, 85525, 163300, 207350, 518400]},
                     {'married_joined': [19750, 80250, 171050, 326600, 414700, 622050]},
                     {'married_separate': [9875, 40125, 85525, 163300, 207350, 311025]},
                     {'head_of_house': [14100, 53700, 85500, 163300, 207350, 518400]}
                ]
                 },
                {'state': [
                    {'massachusetts': 0.0505},
                    {'vermont': [
                        {'single': []},
                        {'married_joined': []},
                        {'married_separate': []},
        ...
        def calculate_interest(self):
            ...
            total_interest = 0
            print(remaining_principle, monthly_interest, payment_due)
            while True:
        ...
        # Total property tax by location
        ...
        # Maintenance is only for a house right now. Randomly making it one half of a percent of the house value.
        # Felt right.
    ...
    trial_one = run_program(100000, 50000, 15, 3.75, 12, {'Massachusetts': 'Tewksbury'}, 'House', 100000, 'single')
    trial_one.calculate_total_costs()
    # trial_two = run_program(300000, 9000, 30, 3.75, 12, {'Massachusetts': 'North Reading'}, 'House', 84000)
    # trial_two.calculate_total_costs()
    # trial_three = run_program(1000000, 300000, 30, 3.75, 12, {'Massachusetts': 'Andover'}, 'House', 1000000)
    # trial_three.calculate_total_costs()
